...
class ProductQuery:
    ...
    def build_item_group_filters(self, item_group):
        ...
        item_group_filters.append(
            ["Website Item", "item_group", "=", item_group])
    ...
    def build_search_filters(self, search_term):
        ...
        default_fields = {"item_code", "item_name",
                          "web_long_description", "item_group"}
    ...
    def add_display_details(self, result, discount_list, cart_items):
        ...
        for item in result:
            ...
            if product_info and product_info["price"]:
                ...
                self.get_price_discount_info(
                    item, product_info["price"], discount_list)
